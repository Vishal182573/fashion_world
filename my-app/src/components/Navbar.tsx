  ...
  return (
    <nav className="shadow-lg sticky top-0 bg-white z-50">
        ...
        <div className="flex items-center justify-between h-20">
          ...
          >
            <Link href="/" className="flex-shrink-0 hover:opacity-80 transition-opacity duration-300">
              <Image src={LOGO} alt='LOGO' width={60} height={60} className='rounded-full shadow-md'/>
            </Link>
      ...
      <motion.div
        ...
        className={`${isOpen ? 'block' : 'hidden'} md:hidden bg-white shadow-lg rounded-b-lg`}
      >
